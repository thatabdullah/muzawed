<div class="w-full bg-gradient-to-r from-blue-200 to-cyan-200 py-10 px-4 sm:px-6 lg:px-8 mx-auto" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}">
      ...
      <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
          ...
          <div class="space-y-6">
              <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
                  {{ __('homepage.slogan') }} <span class="text-blue-600">{{__('homepage.muzawed')}}</span>
              </h1>
              <p class="mt-3 text-lg font-bold text-gray-800 dark:text-gray-800">{{ __('homepage.sub_slogan') }}</p>
              <!-- Buttons -->
              <div class="mt-7 grid gap-3 w-full sm:inline-flex {{ app()->getLocale() === 'ar' ? 'sm:flex-row-reverse' : '' }}">
